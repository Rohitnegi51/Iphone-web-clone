...
const VideoCarousel = () => {
    ...
    useEffect(()=>{
      ...
      //videoSpanRef.current(is an array which can have value after using useRef[]) does not re-render , making it suitable for mutable values that do not trigger re-renders
